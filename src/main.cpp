...
void exibirMenu() {
    ...
    cout << "1. Exibir Grafo Atual" << endl;
    cout << "2. Executar Algoritmo de Dijkstra" << endl;
    cout << "3. Inserir Vertice" << endl;
    cout << "4. Remover Vertice" << endl;
    cout << "5. Inserir Aresta" << endl;
    cout << "6. Remover Aresta" << endl;
    cout << "7. Alterar peso Aresta" << endl;
    cout << "0. Sair" << endl;
    cout << "Escolha uma opcao: ";
}

void limparEntrada() {// Limpar buffer de entrada
    cin.clear(); // limpa failbit/badbit
